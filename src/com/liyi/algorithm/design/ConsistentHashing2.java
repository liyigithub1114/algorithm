...
public class ConsistentHashing2 {
    public static void main(String[] args) {
        Solution solution = new Solution(100,3);
        List<Integer> list = solution.addMachine(1);
        System.out.println("机器号为 1 的 list 值为 ：" + list);
        List<Integer> list2 = solution.addMachine(2);
        System.out.println("机器号为 2 的 list 值为 ：" + list2);
        List<Integer> list3 = solution.addMachine(3);
        System.out.println("机器号为 3 的 list 值为 ：" + list3);
        int machineIdByHashCode = solution.getMachineIdByHashCode(50);
        System.out.println(machineIdByHashCode);
